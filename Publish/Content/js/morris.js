jQuery(function () {
    'use strict';
    if (jQuery('#morris-line-example').length) {
        Morris.Line({
    ...
    if (jQuery('#morris-area-example').length) {
        Morris.Area({
    ...
    if (jQuery("#morris-bar-example").length) {
        Morris.Bar({
    ...
    if (jQuery("#morris-donut-example").length) {
        Morris.Donut({
    ...
    if (jQuery('#morris-dashboard-taget').length) {
        Morris.Area({
