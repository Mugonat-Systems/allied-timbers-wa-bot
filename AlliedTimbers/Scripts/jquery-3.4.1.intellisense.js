intellisense.annotate($, {
    'ajax': function () {
        ...
        ///   <param name="settings" type="PlainObject">A set of key/value pairs that configure the Ajax request. All settings are optional. A default can be set for any option with $.ajaxSetup(). See $.ajax( settings ) below for a complete list of all settings.</param>
        ///   <returns type="jqXHR" />
        /// </signature>
        /// <signature>
        ///   <summary>Perform an asynchronous HTTP (Ajax) request.</summary>
    ...
    'boxModel': function () {
        /// <summary>Deprecated in $ 1.3 (see $.support). States if the current page, in the user's browser, is being rendered using the W3C CSS Box Model.</summary>
        /// <returns type="Boolean" />
    },
    'browser': function () {
        /// <summary>Contains flags for the useragent, read from navigator.userAgent. This property was removed in $ 1.9 and is available only through the $.migrate plugin. Please try to use feature detection instead.</summary>
        /// <returns type="PlainObject" />
    },
    'browser.version': function () {
        /// <summary>The version number of the rendering engine for the user's browser. This property was removed in $ 1.9 and is available only through the $.migrate plugin.</summary>
        /// <returns type="String" />
    },
    'Callbacks': function () {
        /// <signature>
    ...
    'cssHooks': function () {
        /// <summary>Hook directly into $ to override how particular CSS properties are retrieved or set, normalize CSS property naming, or create custom properties.</summary>
        /// <returns type="Object" />
    },
    'data': function () {
        /// <signature>
        ///   <summary>Returns value at named data store for the element, as set by $.data(element, name, value), or the full data store for the element.</summary>
    ...
    'extend': function () {
        ...
        ///   <param name="target" type="Object">An object that will receive the new properties if additional objects are passed in or that will extend the $ namespace if it is the sole argument.</param>
    ...
    'fn.extend': function () {
        /// <signature>
        ///   <summary>Merge the contents of an object onto the $ prototype to provide new $ instance methods.</summary>
        ///   <param name="object" type="Object">An object to merge onto the $ prototype.</param>
        ///   <returns type="Object" />
        /// </signature>
    },
    'get': function () {
    ...
    'hasData': function () {
        /// <signature>
        ///   <summary>Determine whether an element has any $ data associated with it.</summary>
    ...
    'holdReady': function () {
        /// <signature>
        ///   <summary>Holds or releases the execution of $'s ready event.</summary>
    ...
    'noConflict': function () {
        /// <signature>
        ///   <summary>Relinquish $'s control of the $ variable.</summary>
        ///   <param name="removeAll" type="Boolean">A Boolean indicating whether to remove all $ variables from the global scope (including $ itself).</param>
        ///   <returns type="Object" />
        /// </signature>
    },
    'noop': function () {
    ...
    'sub': function () {
        /// <summary>Creates a new copy of $ whose properties and methods can be modified without affecting the original $ object.</summary>
        /// <returns type="$" />
    },
    'support': function () {
        /// <summary>A collection of properties that represent the presence of different browser features or bugs. Primarily intended for $'s internal use; specific properties may be removed when they are no longer needed internally to improve page startup performance.</summary>
        /// <returns type="Object" />
    },
    'trim': function () {
        /// <signature>
...
intellisense.redirectDefinition($.Callbacks, _1228819969);

var _731531622 = $.Deferred;
...
intellisense.redirectDefinition($.Callbacks, _731531622);

intellisense.annotate($.Event.prototype, {
    ...
    'delegateTarget': function () {
        /// <summary>The element where the currently-called $ event handler was attached.</summary>
        /// <returns type="Element" />
    },
...
intellisense.annotate($.fn, {
    'add': function () {
        ...
        /// <signature>
        ///   <summary>Add elements to the set of matched elements.</summary>
        ///   <param name="$ object" type="$ object ">An existing $ object to add to the set of matched elements.</param>
        ///   <returns type="$" />
        /// </signature>
        /// <signature>
        ///   <summary>Add elements to the set of matched elements.</summary>
    ...
    'after': function () {
        ...
        ///   <param name="content" type="">HTML string, DOM element, or $ object to insert after each element in the set of matched elements.</param>
        ///   <param name="content" type="">One or more additional DOM elements, arrays of elements, HTML strings, or $ objects to insert after each element in the set of matched elements.</param>
        ///   <returns type="$" />
        /// </signature>
        /// <signature>
        ///   <summary>Insert content, specified by the parameter, after each element in the set of matched elements.</summary>
        ///   <param name="function(index)" type="Function">A function that returns an HTML string, DOM element(s), or $ object to insert after each element in the set of matched elements. Receives the index position of the element in the set as an argument. Within the function, this refers to the current element in the set.</param>
        ///   <returns type="$" />
        /// </signature>
    },
    ...
    'append': function () {
        ...
        ///   <param name="content" type="">DOM element, HTML string, or $ object to insert at the end of each element in the set of matched elements.</param>
        ///   <param name="content" type="">One or more additional DOM elements, arrays of elements, HTML strings, or $ objects to insert at the end of each element in the set of matched elements.</param>
        ///   <returns type="$" />
        /// </signature>
        /// <signature>
        ///   <summary>Insert content, specified by the parameter, to the end of each element in the set of matched elements.</summary>
        ///   <param name="function(index, html)" type="Function">A function that returns an HTML string, DOM element(s), or $ object to insert at the end of each element in the set of matched elements. Receives the index position of the element in the set and the old HTML value of the element as arguments. Within the function, this refers to the current element in the set.</param>
        ///   <returns type="$" />
        /// </signature>
    },
    'appendTo': function () {
        ...
        ///   <param name="target" type="">A selector, element, HTML string, or $ object; the matched set of elements will be inserted at the end of the element(s) specified by this parameter.</param>
        ///   <returns type="$" />
        /// </signature>
    },
    'attr': function () {
    ...
    'before': function () {
        ...
        ///   <param name="content" type="">HTML string, DOM element, or $ object to insert before each element in the set of matched elements.</param>
        ///   <param name="content" type="">One or more additional DOM elements, arrays of elements, HTML strings, or $ objects to insert before each element in the set of matched elements.</param>
        ///   <returns type="$" />
        /// </signature>
        /// <signature>
        ///   <summary>Insert content, specified by the parameter, before each element in the set of matched elements.</summary>
        ///   <param name="function" type="Function">A function that returns an HTML string, DOM element(s), or $ object to insert before each element in the set of matched elements. Receives the index position of the element in the set as an argument. Within the function, this refers to the current element in the set.</param>
        ///   <returns type="$" />
        /// </signature>
    },
    'bind': function () {
    ...
    'clone': function () {
        ...
        ///   <param name="withDataAndEvents" type="Boolean">A Boolean indicating whether event handlers should be copied along with the elements. As of $ 1.4, element data will be copied as well.</param>
        ///   <returns type="$" />
        /// </signature>
        /// <signature>
        ///   <summary>Create a deep copy of the set of matched elements.</summary>
        ///   <param name="withDataAndEvents" type="Boolean">A Boolean indicating whether event handlers and data should be copied along with the elements. The default value is false. *In $ 1.5.0 the default value was incorrectly true; it was changed back to false in 1.5.1 and up.</param>
    ...
    'closest': function () {
        ...
        ///   <summary>For each element in the set, get the first element that matches the selector by testing the element itself and traversing up through its ancestors in the DOM tree.</summary>
        ///   <param name="selector" type="String">A string containing a selector expression to match elements against.</param>
        ///   <param name="context" type="Element">A DOM element within which a matching element may be found. If no context is passed in then the context of the $ set will be used instead.</param>
        ///   <returns type="$" />
        /// </signature>
        /// <signature>
        ///   <summary>For each element in the set, get the first element that matches the selector by testing the element itself and traversing up through its ancestors in the DOM tree.</summary>
        ///   <param name="$ object" type="$">A $ object to match elements against.</param>
        ///   <returns type="$" />
        /// </signature>
        /// <signature>
        ///   <summary>For each element in the set, get the first element that matches the selector by testing the element itself and traversing up through its ancestors in the DOM tree.</summary>
    ...
    'context': function () {
        /// <summary>The DOM node context originally passed to $(); if none was passed then context will likely be the document.</summary>
        /// <returns type="Element" />
    },
    'css': function () {
        /// <signature>
    ...
    'each': function () {
        /// <signature>
        ///   <summary>Iterate over a $ object, executing a function for each matched element.</summary>
    ...
    'filter': function () {
        ...
        /// <signature>
        ///   <summary>Reduce the set of matched elements to those that match the selector or pass the function's test.</summary>
        ///   <param name="$ object" type="Object">An existing $ object to match the current set of elements against.</param>
        ///   <returns type="$" />
        /// </signature>
    },
    'find': function () {
        /// <signature>
        ///   <summary>Get the descendants of each element in the current set of matched elements, filtered by a selector, $ object, or element.</summary>
        ///   <param name="selector" type="String">A string containing a selector expression to match elements against.</param>
        ///   <returns type="$" />
        /// </signature>
        /// <signature>
        ///   <summary>Get the descendants of each element in the current set of matched elements, filtered by a selector, $ object, or element.</summary>
        ///   <param name="$ object" type="Object">A $ object to match elements against.</param>
        ///   <returns type="$" />
        /// </signature>
        /// <signature>
        ///   <summary>Get the descendants of each element in the current set of matched elements, filtered by a selector, $ object, or element.</summary>
    ...
    'get': function () {
        /// <signature>
        ///   <summary>Retrieve one of the DOM elements matched by the $ object.</summary>
    ...
    'html': function () {
        ...
        /// <signature>
        ///   <summary>Set the HTML contents of each element in the set of matched elements.</summary>
        ///   <param name="function(index, oldhtml)" type="Function">A function returning the HTML content to set. Receives the           index position of the element in the set and the old HTML value as arguments.           $ empties the element before calling the function;           use the oldhtml argument to reference the previous content.           Within the function, this refers to the current element in the set.</param>
        ///   <returns type="$" />
        /// </signature>
    },
    'id': function () {
    ...
    'index': function () {
        ...
        ///   <param name="selector" type="String">A selector representing a $ collection in which to look for an element.</param>
        ///   <returns type="Number" />
        /// </signature>
        /// <signature>
        ///   <summary>Search for a given element from among the matched elements.</summary>
        ///   <param name="element" type="">The DOM element or first element within the $ object to look for.</param>
        ///   <returns type="Number" />
        /// </signature>
    },
    'init': function () {
        ...
        ///   <param name="context" type="">A DOM Element, Document, or $ to use as context</param>
        ///   <returns type="$" />
        /// </signature>
        /// <signature>
        ///   <summary>Accepts a string containing a CSS selector which is then used to match a set of elements.</summary>
        ///   <param name="element" type="Element">A DOM element to wrap in a $ object.</param>
        ///   <returns type="$" />
        /// </signature>
        /// <signature>
        ///   <summary>Accepts a string containing a CSS selector which is then used to match a set of elements.</summary>
        ///   <param name="elementArray" type="Array">An array containing a set of DOM elements to wrap in a $ object.</param>
        ///   <returns type="$" />
        /// </signature>
        /// <signature>
        ///   <summary>Accepts a string containing a CSS selector which is then used to match a set of elements.</summary>
        ///   <param name="object" type="PlainObject">A plain object to wrap in a $ object.</param>
        ///   <returns type="$" />
        /// </signature>
        /// <signature>
        ///   <summary>Accepts a string containing a CSS selector which is then used to match a set of elements.</summary>
        ///   <param name="$ object" type="PlainObject">An existing $ object to clone.</param>
        ///   <returns type="$" />
        /// </signature>
    },
    ...
    'insertAfter': function () {
        ...
        ///   <param name="target" type="">A selector, element, HTML string, or $ object; the matched set of elements will be inserted after the element(s) specified by this parameter.</param>
        ///   <returns type="$" />
        /// </signature>
    },
    'insertBefore': function () {
        ...
        ///   <param name="target" type="">A selector, element, HTML string, or $ object; the matched set of elements will be inserted before the element(s) specified by this parameter.</param>
        ///   <returns type="$" />
        /// </signature>
    },
    'is': function () {
        /// <signature>
        ///   <summary>Check the current matched set of elements against a selector, element, or $ object and return true if at least one of these elements matches the given arguments.</summary>
        ///   <param name="selector" type="String">A string containing a selector expression to match elements against.</param>
        ///   <returns type="Boolean" />
        /// </signature>
        /// <signature>
        ///   <summary>Check the current matched set of elements against a selector, element, or $ object and return true if at least one of these elements matches the given arguments.</summary>
        ///   <param name="function(index)" type="Function">A function used as a test for the set of elements. It accepts one argument, index, which is the element's index in the $ collection.Within the function, this refers to the current DOM element.</param>
        ///   <returns type="Boolean" />
        /// </signature>
        /// <signature>
        ///   <summary>Check the current matched set of elements against a selector, element, or $ object and return true if at least one of these elements matches the given arguments.</summary>
    ...
    'jquery': function () {
        /// <summary>A string containing the $ version number.</summary>
        /// <returns type="String" />
    },
    'keydown': function () {
        /// <signature>
    ...
    'length': function () {
        /// <summary>The number of elements in the $ object.</summary>
        /// <returns type="Number" />
    },
    'live': function () {
        /// <signature>
        ///   <summary>Attach an event handler for all elements which match the current selector, now and in the future.</summary>
        ///   <param name="events" type="String">A string containing a JavaScript event type, such as "click" or "keydown." As of $ 1.4 the string can contain multiple, space-separated event types or custom event names.</param>
        ///   <param name="handler(eventObject)" type="Function">A function to execute at the time the event is triggered.</param>
        ///   <returns type="$" />
        /// </signature>
        /// <signature>
    ...
    'map': function () {
        /// <signature>
        ///   <summary>Pass each element in the current matched set through a function, producing a new $ object containing the return values.</summary>
    ...
    'nextUntil': function () {
        /// <signature>
        ///   <summary>Get all following siblings of each element up to but not including the element matched by the selector, DOM node, or $ object passed.</summary>
        ...
        /// <signature>
        ///   <summary>Get all following siblings of each element up to but not including the element matched by the selector, DOM node, or $ object passed.</summary>
        ///   <param name="element" type="Element">A DOM node or $ object indicating where to stop matching following sibling elements.</param>
        ///   <param name="filter" type="String">A string containing a selector expression to match elements against.</param>
        ///   <returns type="$" />
        /// </signature>
    },
    'not': function () {
        ...
        /// <signature>
        ///   <summary>Remove elements from the set of matched elements.</summary>
        ///   <param name="$ object" type="PlainObject">An existing $ object to match the current set of elements against.</param>
        ///   <returns type="$" />
        /// </signature>
    },
    'nth-child': function () {
    ...
    'parentsUntil': function () {
        /// <signature>
        ///   <summary>Get the ancestors of each element in the current set of matched elements, up to but not including the element matched by the selector, DOM node, or $ object.</summary>
        ...
        /// <signature>
        ///   <summary>Get the ancestors of each element in the current set of matched elements, up to but not including the element matched by the selector, DOM node, or $ object.</summary>
        ///   <param name="element" type="Element">A DOM node or $ object indicating where to stop matching ancestor elements.</param>
        ///   <param name="filter" type="String">A string containing a selector expression to match elements against.</param>
        ///   <returns type="$" />
        /// </signature>
    },
    ...
    'prepend': function () {
        ...
        ///   <param name="content" type="">DOM element, array of elements, HTML string, or $ object to insert at the beginning of each element in the set of matched elements.</param>
        ///   <param name="content" type="">One or more additional DOM elements, arrays of elements, HTML strings, or $ objects to insert at the beginning of each element in the set of matched elements.</param>
        ///   <returns type="$" />
        /// </signature>
        /// <signature>
        ///   <summary>Insert content, specified by the parameter, to the beginning of each element in the set of matched elements.</summary>
        ///   <param name="function(index, html)" type="Function">A function that returns an HTML string, DOM element(s), or $ object to insert at the beginning of each element in the set of matched elements. Receives the index position of the element in the set and the old HTML value of the element as arguments. Within the function, this refers to the current element in the set.</param>
        ///   <returns type="$" />
        /// </signature>
    },
    'prependTo': function () {
        ...
        ///   <param name="target" type="">A selector, element, HTML string, or $ object; the matched set of elements will be inserted at the beginning of the element(s) specified by this parameter.</param>
        ///   <returns type="$" />
        /// </signature>
    },
    'prev': function () {
    ...
    'prevUntil': function () {
        /// <signature>
        ///   <summary>Get all preceding siblings of each element up to but not including the element matched by the selector, DOM node, or $ object.</summary>
        ...
        /// <signature>
        ///   <summary>Get all preceding siblings of each element up to but not including the element matched by the selector, DOM node, or $ object.</summary>
        ///   <param name="element" type="Element">A DOM node or $ object indicating where to stop matching preceding sibling elements.</param>
        ///   <param name="filter" type="String">A string containing a selector expression to match elements against.</param>
        ///   <returns type="$" />
        /// </signature>
    },
    ...
    'pushStack': function () {
        /// <signature>
        ///   <summary>Add a collection of DOM elements onto the $ stack.</summary>
        ///   <param name="elements" type="Array">An array of elements to push onto the stack and make into a new $ object.</param>
        ///   <returns type="$" />
        /// </signature>
        /// <signature>
        ///   <summary>Add a collection of DOM elements onto the $ stack.</summary>
        ///   <param name="elements" type="Array">An array of elements to push onto the stack and make into a new $ object.</param>
        ///   <param name="name" type="String">The name of a $ method that generated the array of elements.</param>
        ///   <param name="arguments" type="Array">The arguments that were passed in to the $ method (for serialization).</param>
        ///   <returns type="$" />
        /// </signature>
    },
    'queue': function () {
    ...
    'replaceAll': function () {
        ...
        ///   <param name="target" type="">A selector string, $ object, or DOM element reference indicating which element(s) to replace.</param>
        ///   <returns type="$" />
        /// </signature>
    },
    'replaceWith': function () {
        ...
        ///   <param name="newContent" type="">The content to insert. May be an HTML string, DOM element, or $ object.</param>
        ///   <returns type="$" />
        /// </signature>
        /// <signature>
        ///   <summary>Replace each element in the set of matched elements with the provided new content and return the set of elements that was removed.</summary>
    ...
    'selector': function () {
        /// <summary>A selector representing selector passed to $(), if any, when creating the original set.</summary>
        /// <returns type="String" />
    },
    'serialize': function () {
    ...
    'size': function () {
        /// <summary>Return the number of elements in the $ object.</summary>
        /// <returns type="Number" />
    },
    'slice': function () {
        /// <signature>
    ...
    'toArray': function () {
        /// <summary>Retrieve all the DOM elements contained in the $ set, as an array.</summary>
        /// <returns type="Array" />
    },
    'toggle': function () {
        /// <signature>
    ...
    'trigger': function () {
        ...
        /// <signature>
        ///   <summary>Execute all handlers and behaviors attached to the matched elements for the given event type.</summary>
        ///   <param name="event" type="Event">A $.Event object.</param>
        ///   <param name="extraParameters" type="">Additional parameters to pass along to the event handler.</param>
        ///   <returns type="$" />
        /// </signature>
    },
    ...
    'wrap': function () {
        ...
        ///   <param name="wrappingElement" type="">A selector, element, HTML string, or $ object specifying the structure to wrap around the matched elements.</param>
        ///   <returns type="$" />
        /// </signature>
        /// <signature>
        ///   <summary>Wrap an HTML structure around each element in the set of matched elements.</summary>
        ///   <param name="function(index)" type="Function">A callback function returning the HTML content or $ object to wrap around the matched elements. Receives the index position of the element in the set as an argument. Within the function, this refers to the current element in the set.</param>
        ///   <returns type="$" />
        /// </signature>
    },
    'wrapAll': function () {
    ...
    'wrapInner': function () {
        ...
        ///   <param name="wrappingElement" type="String">An HTML snippet, selector expression, $ object, or DOM element specifying the structure to wrap around the content of the matched elements.</param>
        ///   <returns type="$" />
        /// </signature>
        /// <signature>
        ///   <summary>Wrap an HTML structure around the content of each element in the set of matched elements.</summary>
